...
namespace BakeryInventorySystem
{
    public partial class frmUser : Form
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            if( txtname.Text != "" && txtusername.Text != "" && txtpass.Text  != "" && cbotype.Text != "" )
            {
                ...
                { 
                    ...
                    config.Execute_CUD(query, "Nowy żytkownik nie został zapisany.", "Nowy użytkownik został zapisany.");
                }
                else
                { 
                    ...
                    config.Execute_CUD(query, "Użytkownik nie został zauktualizowany.", "Użytkownik został zauktualizowany.");
                }
                btnnew_Click(sender, e);
            }
            else
            {
                MessageBox.Show("Wypełnienie pól jest wymagane!", "Invalid", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            } 
        }
        ...
        { 
            ...
            config.Execute_CUD(query, "Użytkownik nie został usunięty.", "Użytkownik został usunięty.");
